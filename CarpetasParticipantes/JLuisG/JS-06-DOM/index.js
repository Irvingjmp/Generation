...
const inputOne = document.getElementById("inputText");
//La estructura de como interactuamos con el Dom en JS es la siguiente
// 1.Palabra reservada:  document
// 2. Utilizamos el metodo/API ==> . nodo, getElementById()
// 3. Utilizamos el atributo del elemento que en este caso, conocemos previamente que es un input. Por ese conocimiento previo. value
